...
export default function Navbar() {
  return (
    <nav className="bg-gray-800 text-white px-6 py-4 flex gap-4 flex-wrap">
      ...
      <Link href="/lista-invitados-novio" className="hover:underline">Invitados Novio</Link>
      <Link href="/lista-invitados-novia" className="hover:underline">Invitados Novia</Link>
      <Link href="/mapa-asientos" className="hover:underline">Mapa Asientos</Link>
      <Link href="/pago-proveedores" className="hover:underline">Pago Proveedores</Link>
