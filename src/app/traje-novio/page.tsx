...
export default function TrajeNovioPage() {
  return (
    <main className="min-h-screen bg-blue-50 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white p-8 shadow-xl rounded-xl border border-blue-200">
        <h1 className="text-3xl font-bold text-blue-700 mb-6 text-center">Traje del Novio</h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Campo label="Tienda de trajes" name="tienda" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Campo label="Precio del traje" name="precio" />
    ...
    <div>
      ...
      {textarea ? (
        <textarea
          name={name}
          rows={3}
          className="w-full rounded-xl border border-gray-300 px-4 py-2 text-sm shadow-sm focus:ring-blue-300 focus:border-blue-400 transition"
        />
      ) : (
        <input
          type="text"
